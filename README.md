...
You then press manage modes, search Python and press Python Mode for Processing by Jonathan Feinberg and download it. Once it is downloaded, press the Java symbol again, and you will be able to change it to Python mode.
If you save your new sketch as, you will be able to access your sketch's folder, which I'd recommend saving to desktop for easier access. Make sure all the images from my GitHub file from the "datacodea2" folder are downloaded into your Processing Sketch's folder. Once the images are added to the folder from the Git, it will run along with the code pasted into your sketch that can also be found in the "datacodea2" folder under "datacodea2.pyde".
